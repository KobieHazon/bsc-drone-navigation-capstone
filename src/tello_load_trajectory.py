...
# rostopic pub /tello/trajectory_path std_msgs/String "data: 'trajectory_list.txt'"
# rostopic pub /tello/trajectory_path std_msgs/String "data: 'salon_route_from_entrance.csv'"
